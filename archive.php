...
<div id="content">
	...
	<div <?php post_class(); ?> id="post-<?php the_ID(); ?>"><!-- post div -->
		...
		<div class="post-info-top">
			...
			<span id="gotocomments"><?php comments_popup_link(__('No comment', 'paramitopia'), '1 '.__('comment', 'paramitopia'), '% '.__('comments', 'paramitopia')); ?><?php if(function_exists('the_views')) { echo " | ";the_views(); } ?></span>
		</div>
		<div class="clear"></div>
		<div class="entry">
